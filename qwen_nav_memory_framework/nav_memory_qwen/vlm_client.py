...
class HeuristicVLMClient(BaseVLMClient):
    ...
    def decide(self, vlm_input: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if goal_dist <= self.stop_distance_m:
            return make_stop_output(reason="S02_TARGET_REACHED_OR_TASK_DONE")
        ...
        return make_rotate_output(max(-90.0, min(90.0, goal_bearing)), reason="R01_GOAL_OUTSIDE_CURRENT_VIEW", confidence="medium")
