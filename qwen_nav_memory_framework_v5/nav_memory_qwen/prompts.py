...
- If the current provisional node and a candidate should be merged, add memory_ops: [{"op":"request_merge_nodes","keep_node_id":"candidate","remove_node_id":"current","confidence":0.0-1.0,"reason":"..."}]. The backend will verify and will soft-link/preserve nodes before committing; it will not hard-delete revisit nodes by default.
